                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center text-center-height">
                            ...
                            <a href="#" data-toggle="modal" data-target="#delProductModal"><button class="btn btn-danger mb-1"><i class="fas fa-trash-alt"></i></button></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<div class="modal fade" id="delProductModal" tabindex="-1" role="dialog" aria-labelledby="delProductModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div style="top: 250px;" class="modal-content">
            ...
            <div class="modal-body">Bạn có chắc chắn xóa sản phẩm này không?</div>
            <div class="modal-footer">
                <a class="btn btn-grape" href="{{url('/admin/xoa-san-pham/'.$pro->product_id)}}">Xóa</a>
